          ...
          return (
            <Fragment key={idx}>
                  ...
                  {data.tags.map((tag, index) => {
                    return (
                      <li key={index} className="mt-2 px-5">
                        <a href={SvgIcons[tag as keyof typeof SvgIcons][1]} className="cursor-pointer" rel="noopener noreferrer">
                          <Image
                            layout="fixed"
              ...
              <ul className="flex justify-center md:justify-start">
                <li className="px-5">
                  <a href={data.link} className="cursor-pointer" rel="noopener noreferrer">
                    <Image
                      layout="fixed"
                      src={ExternalLink}
                ...
                <li className="px-5 flex items-center">
                  <a href={data.github} className="cursor-pointer" rel="noopener noreferrer">
                    <Image
                      layout="fixed"
                      src={Github}
                      alt="Github-icon"
